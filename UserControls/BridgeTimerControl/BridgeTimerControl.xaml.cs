...
namespace DBF.UserControls
{
    ...
    public partial class BridgeTimerControl : UserControl
    {
        ...
        #region Dependency Properties
            //#region Visiblity Dependency Property
            //    public Visibility Visiblity
            //    {
            //        get => (Visibility)GetValue(VisiblityProperty);
            //        set => SetValue(VisiblityProperty, value);
            //    }

            //    public static readonly DependencyProperty VisiblityProperty = DependencyProperty.Register( nameof(Visiblity)
            //                                                                                             , typeof(Visibility)
            ...
            //            ctl.Visibility = ctl.Setting.Visibility = (Visibility)e.NewValue;
            //    }
            //#endregion
            ...
            #region WarningVisiblity Dependency Property
                ...
                #region Setting Dependency Property
                    ...
                    // Tilføj dette felt til BridgeTimerControl-klassen:
                    ...
                    private static void onSettingChanged(object sender, PropertyChangedEventArgs e, BridgeTimerControl ctl)
                    {
